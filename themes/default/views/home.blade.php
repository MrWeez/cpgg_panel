                                    ...
                                    <div class="row justify-content-between">
                                        <div class="mt-3 col-12 col-md">
                                            <span class="badge badge-success w-100" style="font-size: 14px">
                                                ...
                                                <span onmouseover="hoverIn()" onmouseout="hoverOut()"
                                                    onclick="onClickCopy()" id="RefLink" style="cursor: pointer;">
                                                    {{ __('Click to copy') }}
                                                </span>
                                            </span>
                                        </div>
                                        <div class="mt-3 col-12 col-md">
                                            <span class="badge badge-info w-100"
                                                style="font-size: 14px">{{ __('Number of referred
                                                                                                                                            users:') }}
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $partnerDiscount->referral_system_commission == -1
                                                        ...
                                                        : $partnerDiscount->referral_system_commission }}%
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
